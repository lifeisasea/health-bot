...
def router_prompt() -> str:
    ...
    return (
        ...
        '- ПОПРАВЛЯЕТ распознанную еду (например «это лосось, а не помидоры», «там был булгур, не рис») → '
        '{"type":"correct_meal","match":"<ошибочное слово из дневника, напр. помидор>",'
        '"description":"<исправленное блюдо>","calories":N,"protein_g":N,"fat_g":N,"carbs_g":N} '
        "— пересчитай КБЖУ под исправленное блюдо.\n"
